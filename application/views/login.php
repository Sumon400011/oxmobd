						...
						<div class="row mx-0 h-100">
							...
							<div class="col-md-5 h-100 login_left" style="background: url('<?= base_url();?>assets/img/dot_pattern.png') rgba(58, 177, 155, 0.7);">
								...
								<div class=" left_container text-center d-flex justify-content-center align-items-center h-100" >
									<div>
										...
										<a href="<?= base_url('Signup')?>" class="btn btn-outline-white rounded-pill"><u>Sign Up</u></a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-7 login_right">
								<div class="right_container text-center d-flex justify-content-center align-items-center h-100">
									<div class="w-75">
										<h2 class="font-weight-bold text-default mb-5">Sign in</h2>
										
										<form>
											<div class="input-group mb-3 light p-1" style="background-color: #E0E0E0;">
											...
											<div class="d-flex justify-content-center">
												<button class="btn btn-default rounded-pill mt-3" style="background-color: #E0E0E0;">Sign In</button>
											</div>
